...
erpnext.buying.PurchaseOrderController = erpnext.buying.BuyingController.extend({
	...
	make_inter_company_order: function(frm) {
		frappe.model.open_mapped_doc({
			method: "niyopolymers.niyopolymers.doctype.import_po.import_po.make_inter_company_sales_order",
			frm: frm
		});
	},
	...
	make_purchase_receipt: function() {
		frappe.model.open_mapped_doc({
			method: "niyopolymers.niyopolymers.doctype.import_po.import_po.make_purchase_receipt",
			frm: cur_frm
		})
	},
	...
	make_purchase_invoice: function() {
		frappe.model.open_mapped_doc({
			method: "niyopolymers.niyopolymers.doctype.import_po.import_po.make_purchase_invoice",
			frm: cur_frm
		})
	},
	...
	add_from_mappers: function() {
		...
		this.frm.add_custom_button(__('Material Request'),
			function() {
				erpnext.utils.map_current_doc({
					method: "niyopolymers.niyopolymers.doctype.import_po.import_po.make_purchase_order",
		...
		function() {
			...
			frappe.call({
				method: "niyopolymers.niyopolymers.doctype.import_po.import_po.get_linked_material_requests",
				args:{
					items: my_items
				},
				callback: function(r) {
...
cur_frm.cscript.update_status= function(label, status){
	frappe.call({
		method: "niyopolymers.niyopolymers.doctype.import_po.import_po.update_status",
